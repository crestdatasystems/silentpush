...
class SilentpushConnector(BaseConnector):
    ...
    def initialize(self):
        ...
        self.util = SilentpushUtils(self)
    ...
    def _is_valid_ip(self, input_ip_address):
        """Check the given address and return True if the address is a valid IP address.
        ...
        try:
            ...
            self.debug_print(f"Error while validating IP {e}.")
            return False
