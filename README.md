...
This table lists the configuration variables required to operate Silent Push. These variables are specified when configuring a Silent Push asset in Splunk SOAR.
