# File: test_silentpush_get_ipv4_reputation.py
#
...
class SilentpushAction(unittest.TestCase):
    """Class to test the get ipv4 reputation action."""
    ...
    def test_get_ipv4_reputation_valid(self, mock_get):
        """Test the valid case for the get ipv4 reputation action.
    ...
    def test_get_ipv4_reputation_invalid(self, mock_get):
        """Test the invalid case for the get ipv4 reputation action.
    ...
    def test_get_ipv4_reputation_limit_type_invalid(self, mock_get):
        """Test the invalid type case for the get ipv4 reputation action.
