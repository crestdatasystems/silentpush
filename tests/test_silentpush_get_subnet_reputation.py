...
class SilentpushAction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_json.update(
            {"action": "get subnet reputation", "identifier": "get_subnet_reputation"}
        )
    ...
    def test_get_subnet_reputation_valid(self, mock_get):
        ...
        self.test_json["parameters"] = [
            {"subnet": "20.207.73.82/10", "limit": 3, "explain": True}
        ]

        mock_get.return_value.status_code = 200
        mock_get.return_value.headers = silentpush_constant.DEFAULT_JSON_HEADERS
        mock_get.return_value.json.return_value = (
            silentpush_responses.GET_SUBNET_REPUTATION_VALID_RESP
        )
