...
class SilentpushAction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.run_job_endpoint = consts.GET_SUBNET_REPUTATION_ENDPOINT.replace("{{subnet}}", "20.207.73.82/10")
    ...
    def test_get_subnet_reputation_valid(self, mock_get):
        ...
        """
        self.test_json["parameters"] = [{"subnet": "20.207.73.82/10", "limit": 3, "explain": True}]
