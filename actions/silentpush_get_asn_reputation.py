...
class GetAsnReputation(BaseAction):
    ...
    def __handle_response(self, ret_val, response):
        ...
        summary = {"total_asn_reputations": len(response.get("response", {}).get("asn_reputation_history", []))}
        self._action_result.update_summary(summary)

        return self._action_result.set_status(phantom.APP_SUCCESS, consts.ACTION_ASN_REPUTATION_SUCCESS_RESPONSE)
