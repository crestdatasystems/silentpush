# File: silentpush_get_subnet_reputation.py
#
...
class GetSubnetReputation(BaseAction):
    """Class to handle get subnet reputation action."""

    def execute(self):
        """Execute get subnet reputation action.
